                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/apps1/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/chola_fi/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                          client: lead.clientName,
                                          leadid: lead.leadId,
                                          // fidatal: lead.fiData,
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/paysense_fi/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                          client: lead.clientName,
                                          leadid: lead.leadId,
                                          //fidatal: lead.fiData,
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/tata_fi/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                          client: lead.clientName,
                                          leadid: lead.leadId,
                                          //fidatal: lead.fiData,
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/hytone_fi/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                          client: lead.clientName,
                                          leadid: lead.leadId,
                                          //fidatal: lead.fiData,
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/fmec_fi/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                          client: lead.clientName,
                                          leadid: lead.leadId,
                                          //fidatal: lead.fiData,
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (_) => WebViewScreen(
                                          url:
                                              "https://fms.bizipac.com/apinew/fmec_Rem_fi/index.php?lead_id=${lead.leadId}#!/",
                                          customerName: lead.customerName,
                                          client: lead.clientName,
                                          leadid: lead.leadId,
                                          //fidatal: lead.fiData,
